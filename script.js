...
//Loop over prodcts to create an element
...
function createProductElement(product) {
  ...
  productElement.innerHTML = ` <div class="bg-gray-100 flex justify-center relative overflow-hidden group cursor-pointer border rounded-xl">
    ...
    product.name
          ...
          <button
            class="status bg-black text-white absolute bottom-0 left-0 right-0 text-center py-2 translate-y-full transition group-hover:translate-y-0 w-full">Add
            to Cart</button>
        </div>
